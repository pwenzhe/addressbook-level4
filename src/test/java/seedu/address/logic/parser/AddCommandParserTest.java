...
import static seedu.address.logic.commands.CommandTestUtil.FAV_DESC_BOB;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
                ...
                .withPostalCode(VALID_POSTALCODE_BOB).withFavourite(VALID_FAV_BOB).withTags(VALID_TAG_FRIEND).build();

        // multiple names - last name accepted
        assertParseSuccess(parser, AddCommand.COMMAND_WORD + NAME_DESC_AMY + NAME_DESC_BOB + PHONE_DESC_BOB
                + DATE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + POSTALCODE_DESC_BOB + FAV_DESC_BOB
                + TAG_DESC_FRIEND,
        ...
        assertParseSuccess(parser, AddCommand.COMMAND_WORD + NAME_DESC_BOB + PHONE_DESC_BOB + DATE_DESC_BOB
                + EMAIL_DESC_AMY + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + POSTALCODE_DESC_BOB + FAV_DESC_BOB
                + TAG_DESC_FRIEND,
                new AddCommand(expectedPerson));

        // multiple addresses - last address accepted
        assertParseSuccess(parser, AddCommand.COMMAND_WORD + NAME_DESC_BOB + PHONE_DESC_BOB + DATE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_AMY + ADDRESS_DESC_BOB + POSTALCODE_DESC_BOB + FAV_DESC_BOB
                + TAG_DESC_FRIEND,
                new AddCommand(expectedPerson));
        ...
        // multiple favourite - last favourite accepted
        assertParseSuccess(parser, AddCommand.COMMAND_WORD + NAME_DESC_BOB + PHONE_DESC_BOB + DATE_DESC_BOB
        ...
        assertParseSuccess(parser, AddCommand.COMMAND_WORD + NAME_DESC_BOB + PHONE_DESC_BOB + DATE_DESC_BOB
                        + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + POSTALCODE_DESC_BOB + FAV_DESC_BOB
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + DATE_DESC_AMY
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + FAV_DESC_BOB, new AddCommand(expectedPerson));

        // no date
        expectedPerson = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY).withDate("")
        ...
        expectedPerson = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
                .withDate(VALID_DATE_AMY).withEmail("").withAddress(VALID_ADDRESS_AMY).withPostalCode("")
                .withFavourite(VALID_FAV_AMY).withTags()
                .build();
        assertParseSuccess(parser, AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + DATE_DESC_AMY
        ...
        // no address
        expectedPerson = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
                .withDate(VALID_DATE_AMY).withEmail(VALID_EMAIL_AMY).withAddress("").withPostalCode("")
                .withFavourite(VALID_FAV_AMY).withTags()
                .build();
        assertParseSuccess(parser, AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + DATE_DESC_AMY
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, AddCommand.COMMAND_WORD + INVALID_NAME_DESC + PHONE_DESC_BOB + DATE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + FAV_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
        ...
        assertParseFailure(parser, AddCommand.COMMAND_WORD + NAME_DESC_BOB + PHONE_DESC_BOB + DATE_DESC_BOB
                + INVALID_EMAIL_DESC + ADDRESS_DESC_BOB + FAV_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                Email.MESSAGE_EMAIL_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser, AddCommand.COMMAND_WORD + NAME_DESC_BOB + PHONE_DESC_BOB + DATE_DESC_BOB
                        + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC + FAV_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
        ...
        // invalid tag
        assertParseFailure(parser, AddCommand.COMMAND_WORD + NAME_DESC_BOB + PHONE_DESC_BOB + DATE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + FAV_DESC_BOB
