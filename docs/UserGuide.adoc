...
Bevy is able to understand you and offers suggestions to complete your command. The suggestion popup
menu will appear when you start typing in the command box. Below is an example of the suggestion popup
menu.
