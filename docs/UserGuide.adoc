...
=== Changing the theme: `changetheme` `c`
...
|Add |`add` |`a` | `add n/NAME p/PHONE_NUMBER [b/Birthday] [e/EMAIL] [a/ADDRESS] [pc/POSTAL_CODE] t/TAG]...` |`add n/James Ho p/22224444 b/240989 e/jamesho@example.com a/123, Clementi Rd pc/234665 t/friend t/colleague`
