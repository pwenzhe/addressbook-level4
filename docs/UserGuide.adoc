...
=== Show Tag Statistics: `tagstatistics`, `tstats` `Since v1.5rc`
...
_Figure 4.18.1: The dynamic information panel, next to the list of contacts_
...
Bevy is able to understand you and offers suggestions to complete your command. The suggestions popup
menu will appear when you start typing in the command box. Below is an example of the suggestions popup
menu.
