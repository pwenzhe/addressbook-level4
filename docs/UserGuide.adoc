...
** After entering the command, you can see that Brandon Tan has been added as index number 11.
// end::add[]
...
* To find the month, include `m/` to ensure that it does not clash with name search.
