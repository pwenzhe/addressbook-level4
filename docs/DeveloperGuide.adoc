...
The list will be sorted in alphabetical order whenever a new person is added or when a person is edited. The favourite persons will be pinned at the top of the list, sorted according to alphabetical order as well.
