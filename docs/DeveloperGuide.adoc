...
The home command show users the home panel of the app. This panel displays the total number of
...
Bevy can export address book data out onto a .csv file when users enter the export command. Seen in the figure above is the actual file Bevy exports the data to.
...
. `MainApp` will handle the new event, as seen in figure 4.12.3 and save the current address book data using `StorageManager`.
