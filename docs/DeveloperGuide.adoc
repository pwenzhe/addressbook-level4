...
. `UniquePersonList` will sort the added person by comparing the names in the current list and insert the name at the correct slot.
...
This will make it easier for user to view and also assist in executing find command for month.
...
_Figure 4.7.3: Browser Panels Sequence Diagram_
