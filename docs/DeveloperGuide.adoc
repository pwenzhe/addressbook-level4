...
After forking the repository, links in the documentation will still point to the `CS2103AUG2017-T16-B3/Bevy` repository.
If you plan to develop this as a separate product (i.e. instead of contributing to the `CS2103AUG2017-T16-B3/Bevy`),
