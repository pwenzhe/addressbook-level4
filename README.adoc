...
* Bevy is a powerful app, designed to organise and simplify your contacts.
* It has an elegant interface for visual display, with a simple Command Line Interface for you to navigate.
